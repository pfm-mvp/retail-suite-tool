...
st.markdown(f"- **+{conv_add:.1f} pp conversie** en **+{spv_uplift*100:.0f}% SPV** levert **{fmt_eur(extra_gp.sum())}** extra brutowinst op in {months:.1f} mnd; payback ≈ **{('∞' if np.isinf(payback_months) else f'{payback_months:.1f}')} mnd**.")
