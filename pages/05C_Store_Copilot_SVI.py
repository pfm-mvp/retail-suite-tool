...
def main():
    ...
    def svi_for_row(row, bench_vals):
        ...
        svi, avg_ratio, _ = compute_svi_explainable(vals, bench_vals, float(lever_floor), float(lever_cap), weights=w)
    ...
    for idx, r in tmp.iterrows():
        ...
        sreg, _ = svi_for_row(r, b_reg)
        scom, _ = svi_for_row(r, b_com)
