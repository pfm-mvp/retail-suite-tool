...
def render_ai_card(markdown_text: str, subtitle: str = "Live acties op basis van jouw cijfers en de peer‑mediaan."):
    st.markdown(
        '<div class="ai-card">'
        '<div class="ai-title"><span class="dot"></span>🤖 AI‑Insights</div>'
